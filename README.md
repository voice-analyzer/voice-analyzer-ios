...
* iPhone Simulator on 64-bit ARM (e.g. M1 processor): `aarch64-apple-ios-sim` (currently available in nightly)
...
$ rustup target install --toolchain=nightly aarch64-apple-ios-sim
```
